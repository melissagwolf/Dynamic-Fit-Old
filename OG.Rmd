...
renderPlot({
  ...
  SRMR_plot <- plot %>% 
    ...
    geom_vline(xintercept=misspec_sum$SRMR_M[1],
               linetype="dashed",color="red",
               size=.5)+
    geom_vline(xintercept=true_sum$SRMR_T[1],
  ...
  RMSEA_plot <- plot %>% 
    ...
    geom_histogram(position="identity",
                   alpha=.5)+
    scale_fill_manual(values=c("#E9798C","#66C2F5"))+
    geom_vline(xintercept=misspec_sum$RMSEA_M[1],
               linetype="dashed",color="red",
               size=.5)+
    geom_vline(xintercept=true_sum$RMSEA_T[1],
               linetype="dashed",color="blue",
               size=.5)+
    theme(axis.title.y = element_blank(),
          axis.text.y = element_blank(),
  ...
  CFI_plot <- plot %>% 
    ...
    geom_histogram(position="identity",
                   alpha=.5)+
    scale_fill_manual(values=c("#E9798C","#66C2F5"))+
    geom_vline(xintercept=misspec_sum$CFI_M[1],
               linetype="dashed",color="red",
               size=.5)+
    geom_vline(xintercept=true_sum$CFI_T[1],
               linetype="dashed",color="blue",
               size=.5)+
    theme(axis.title.y = element_blank(),
          axis.text.y = element_blank(),

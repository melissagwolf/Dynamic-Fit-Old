...
These are two plots comparing your T-size values to the adjusted cutoff values derived from equivalence testing:
...
The equivalence testing method for structural equation modeling was introduced by Yuan, et. al.  The code to generate the T-size RMSEA was provided by the authors and can be accessed [here](https://www3.nd.edu/~kyuan/EquivalenceTesting/T-size_RMSEA_CFI.R), [here](https://www3.nd.edu/~kyuan/EquivalenceTesting/RMSEA_e.R), and [here](https://www3.nd.edu/~kyuan/EquivalenceTesting/CFI_e.R).  To cite the equivalence testing method:

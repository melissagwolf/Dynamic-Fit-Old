...
These are the misspecifications that were added to your data generating model.  These misspecifications are compounded across levels.  In other words, a level 2 misspecification has the misspecification from level 1 in addition to the misspecification from level 2.  In total, there are F-1 misspecifications, where F is the number of factors in the model. This procedure follows the precedence established by Hu & Bentler (1999).

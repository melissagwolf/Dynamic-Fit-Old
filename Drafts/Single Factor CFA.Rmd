...
This app uses Monte Carlo simulations to generate dynamic model fit index cutoff values for single factor models.
...
**To generate dynamic model fit index cutoffs for single factor models:**
...
<div>
```{r out.width="65%"}
include_graphics(here("Example_Single.png"))
```
</div>

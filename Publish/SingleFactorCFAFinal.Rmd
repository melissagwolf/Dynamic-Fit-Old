...
To learn more about why you should use dynamic fit index cutoffs instead of [Hu & Bentler's (1999)](https://psycnet.apa.org/record/1998-03102-001) fixed fit index cutoff values, consider these articles:
...
- Shi, D., Lee, T., & Maydeu-Olivares, A. [(2019)](https://www.researchgate.net/publication/326077335_Understanding_the_Model_Size_Effect_on_SEM_Fit_Indices). Understanding the model size effect on SEM fit indices. *Educational and Psychological Measurement, 79*(2), 310-334.
- Shi, D., & Maydeu-Olivares, A. [(2020)](https://journals.sagepub.com/doi/10.1177/0013164419885164?icid=int.sj-abstract.citing-articles.1). The Effect of Estimation Methods on SEM Fit Indices. *Educational and Psychological Measurement, 80*(3), 421-445.

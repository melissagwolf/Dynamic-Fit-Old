...
2) Your model's chi-square value.
      ...
      - In lavaan (R), this is the value under chisq under the fitMeasures function.
3) Your model's degrees of freedom.
4) The number of parameters in your model.  These are the number of observed variables, or the number of squares on your path diagram.
5) The chi-square for the baseline model.  This value is only necessary to compute the values for the CFI.  If you do not include it, the app will still print the RMSEA values.
      ...
      - In lavaan (R), this is the value under baseline.chisq under the fitMeasures function.
...
The equivalence testing method for structural equation modeling was introduced by Yuan, et. al.  The code to generate these values was provided by the authors and can be accessed [here](https://www3.nd.edu/~kyuan/EquivalenceTesting/T-size_RMSEA_CFI.R), [here](https://www3.nd.edu/~kyuan/EquivalenceTesting/RMSEA_e.R), and [here](https://www3.nd.edu/~kyuan/EquivalenceTesting/CFI_e.R).  To cite the equivalence testing method:
